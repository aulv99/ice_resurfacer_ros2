...
def generate_wall_lane_change_horizontal(start_x, end_x, start_y, end_y, n_points=40):
    # Drives West (X decreases) while shifting North (Y increases) into the next lane
...
def generate_full_wall_lap_bottom(offset_straight, offset_corner, start_x, end_x):
    ...
    # 1. ENTRY STRAIGHT: Bottom straight, driving West from start_x
    ...
    # 9. EXIT STRAIGHT: Bottom straight, finishing exactly at end_x
...
def generate_zamboni_path():
    ...
    # ==========================================
    # 2. TRANSITION 1 (Lane Change)
    # ==========================================
    # Calculate exactly how far out Lap 0 is drifting when it hits X = -10.0
    ...
    # ==========================================
    # 5. LAP 1 EXTENSION (Drive to the Transition!)
    # ==========================================
    r1 = CORNER_RADIUS - offset_1
    
    # 5a. Finish the remaining bottom straight
